  ...
  public: {
    Tables: {
      ...
      dynamic_table_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "dynamic_table_records_table_id_fkey"
            columns: ["table_id"]
            isOneToOne: false
      ...
      marketing_reminder_logs: {
        Row: {
          created_at: string
          error: string | null
          id: string
          marketing_record_id: string
          owner_id: string
    ...
    Functions: {
      ...
      is_table_owner:
        | { Args: { p_table_id: string }; Returns: boolean }
        | { Args: { p_table_id: string; p_user_id: string }; Returns: boolean }
    }
    Enums: {
      [_ in never]: never
    }
