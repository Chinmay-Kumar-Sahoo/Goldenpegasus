    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#71717a] mt-1">Join GoldenPegasus today</p>
        </div>
        ...
        <div className="bg-[#111111] border border-[#2a2a2a] rounded-2xl p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs text-[#71717a]"><span className="bg-[#111111] px-3">or with email</span></div>
          </div>

          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-[#a1a1aa] mb-1.5" htmlFor="signup-name">Full Name</label>
              <input id="signup-name" type="text" name="fullName" value={form.fullName} onChange={handleChange} required placeholder="John Doe"
            ...
            <div>
              <label className="block text-sm font-medium text-[#a1a1aa] mb-1.5" htmlFor="signup-email">Email address</label>
            ...
            <div>
              <label className="block text-sm font-medium text-[#a1a1aa] mb-1.5" htmlFor="signup-password">Password</label>
              <div className="relative">
                <input id="signup-password" type={showPassword ? "text" : "password"} name="password" value={form.password} onChange={handleChange} required placeholder="Min. 8 characters"
                  suppressHydrationWarning={true}
            ...
            <div>
              <label className="block text-sm font-medium text-[#a1a1aa] mb-1.5" htmlFor="signup-confirm">Confirm Password</label>
              <div className="relative">
                <input id="signup-confirm" type={showConfirm ? "text" : "password"} name="confirmPassword" value={form.confirmPassword} onChange={handleChange} required placeholder="••••••••"
                  suppressHydrationWarning={true}
                  className="w-full bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl px-4 py-3 text-sm text-white placeholder-[#3a3a3a] focus:outline-none focus:border-[#22c55e]/60 focus:ring-1 focus:ring-[#22c55e]/30 transition-all pr-11" />
                <button
                  type="button"
        ...
        <p className="text-center text-sm text-[#71717a] mt-6">
          ...
          <Link href="/login" className="text-[#22c55e] hover:text-[#4ade80] font-medium transition-colors">Sign in</Link>
        </p>
      </div>
    </div>
  )
