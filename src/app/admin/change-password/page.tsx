...
export default function ChangePasswordPage() {
  ...
  useEffect(() => {
    // Verify this page is needed (must_change_password = true)
    const check = async () => {
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#71717a] mt-2 max-w-sm mx-auto">
            For your security, you must set a new password before accessing the admin portal. This is required on first login.
          </p>
        </div>
