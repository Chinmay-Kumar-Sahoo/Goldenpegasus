...
export default async function AllMarketingProfilesPage() {
  ...
  const [recordsResult, employeeProfiles, allProfiles, employeesFromTable, adminProfiles] = await Promise.all([
  ...
  return <ClientsTable isAdmin={false} readOnly={true} initialRecords={records} employeeOptions={employeeOptions} initialOwnerNames={ownerNames} />
}
