      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-6">
            <div className="w-10 h-10 rounded-xl bg-red-500 flex items-center justify-center font-bold text-black">GP</div>
            <span className="font-bold text-white">GoldenPegasus</span>
          </Link>
          <h1 className="text-2xl font-bold text-white">Admin Portal</h1>
          <p className="text-sm text-[#71717a] mt-1">Sign in with your administrative credentials</p>
        </div>
