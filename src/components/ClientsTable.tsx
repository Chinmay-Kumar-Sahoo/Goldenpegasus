    ...
    <div className="flex flex-col flex-1 overflow-hidden">
      ...
      {selectedIds.size > 0 && (
        <div className="mb-4 flex items-center gap-3 bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl px-4 py-2.5">
          ...
          <button onClick={() => { setBulkForm({ status: '', notes: '', project_type: '', company_name: '', address: '' }); setShowBulkModal(true) }} className="text-xs bg-[#22c55e]/10 hover:bg-[#22c55e]/20 text-[#22c55e] border border-[#22c55e]/20 px-3 py-1.5 rounded-lg transition-all">Edit Selected</button>
